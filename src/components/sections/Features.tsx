    ...
    <section className="py-20 bg-background-light dark:bg-background-dark relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
                <h2 className="text-3xl md:text-4xl font-black text-ocean-blue dark:text-white mb-4 tracking-tight">Why Choose LankaHorizon?</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {features.map((feature, index) => (
                    <div key={index} className="group bg-white dark:bg-[#1a2c1d] rounded-2xl p-8 shadow-sm hover:shadow-xl hover:shadow-primary/10 transition-all duration-300 border border-transparent hover:border-primary/20">
                        <div className="w-14 h-14 bg-ocean-light dark:bg-white/5 rounded-full flex items-center justify-center text-ocean-blue dark:text-primary mb-6 group-hover:bg-primary group-hover:text-ocean-blue transition-colors duration-300">
