    ...
    <section className="relative w-full rounded-3xl overflow-hidden shadow-2xl my-24 container mx-auto">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center px-6 py-24 sm:py-32 text-center">
            <div className="mb-6 inline-flex items-center justify-center p-3 bg-white/10 backdrop-blur-md border border-white/20 rounded-full shadow-lg">
                <Trees className="text-primary text-3xl h-8 w-8" />
            </div>
            ...
            <p className="text-gray-200 text-lg sm:text-xl max-w-2xl mb-10 leading-relaxed drop-shadow-md">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                <Button size="lg" asChild className="group relative inline-flex items-center justify-center px-8 py-4 bg-primary text-white font-bold text-lg rounded-full overflow-hidden shadow-[0_0_20px_rgba(37,211,102,0.4)] hover:shadow-[0_0_30px_rgba(37,211,102,0.6)] transition-all transform hover:-translate-y-1 h-auto">
                ...
                <Button size="lg" variant="outline" asChild className="inline-flex items-center justify-center px-8 py-4 bg-transparent border-2 border-white/30 hover:border-white text-white font-medium text-lg rounded-full backdrop-blur-sm transition-all hover:bg-white/10 h-auto">
