        ...
        <div className="bg-background-light dark:bg-background-dark text-foreground antialiased overflow-x-hidden">
            <header className="relative w-full h-[600px] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center px-4 max-w-4xl mx-auto flex flex-col gap-6 items-center">
                    ...
                    <p className="text-white/90 text-lg md:text-xl font-normal leading-relaxed max-w-2xl font-body">
                    ...
                    <Link href="/contact" className="mt-4 flex cursor-pointer items-center justify-center rounded-full h-12 px-8 bg-primary text-primary-foreground text-base font-bold transition transform hover:scale-105">
                        Explore Our Impact
                    </Link>
                </div>
            </header>
            ...
            <section className="relative -mt-16 z-20 px-4 mb-20">
                <div className="max-w-6xl mx-auto bg-card dark:bg-card/80 rounded-xl shadow-xl p-8 grid grid-cols-1 md:grid-cols-3 gap-8 border border-border">
                    <div className="flex flex-col items-center text-center p-4">
                        <p className="text-primary tracking-tight text-5xl font-black leading-tight font-display">5000+</p>
                        <p className="text-foreground dark:text-gray-300 text-sm font-medium uppercase tracking-wide mt-2">Happy Travelers</p>
                    ...
                    <div className="relative flex flex-col items-center text-center p-4 md:border-x md:border-gray-200 md:dark:border-gray-700">
                        <p className="text-primary tracking-tight text-5xl font-black leading-tight font-display">10</p>
                        <p className="text-foreground dark:text-gray-300 text-sm font-medium uppercase tracking-wide mt-2">Years Experience</p>
                        <p className="text-muted-foreground text-xs mt-1">Proven expertise in Sri Lanka tourism</p>
                    </div>
                    <div className="flex flex-col items-center text-center p-4">
                        <p className="text-primary tracking-tight text-5xl font-black leading-tight font-display">150+</p>
                        <p className="text-foreground dark:text-gray-300 text-sm font-medium uppercase tracking-wide mt-2">Destinations Covered</p>
            ...
            <section className="py-16 px-4 md:px-10 lg:px-20 max-w-7xl mx-auto">
                <div className="flex flex-col lg:flex-row gap-12 items-center">
                    <div className="flex-1 space-y-6">
                        ...
                        <h2 className="text-foreground text-3xl md:text-5xl font-black leading-tight tracking-tight font-display">
                        ...
                        <Link href="/about" className="mt-4 flex items-center gap-2 text-foreground font-bold text-lg hover:text-primary transition-colors group">
                    ...
                    <div className="flex-1 grid grid-cols-2 gap-4 w-full h-full relative">
                        <div className="col-span-2 md:col-span-1 md:translate-y-12">
                            <div className="w-full h-64 md:h-80 rounded-xl shadow-lg transform hover:rotate-1 transition duration-500 overflow-hidden relative">
            ...
            <section className="py-20 bg-card/50 dark:bg-card/80 transition-colors duration-300">
                <div className="max-w-7xl mx-auto px-4 md:px-10">
                    <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
                        <h2 className="text-foreground text-3xl md:text-4xl font-black leading-tight font-display">Why Choose LankaHorizon: A Clear Advantage</h2>
                        <p className="text-muted-foreground text-lg">Compare our key benefits to make your decision with confidence.</p>
                    </div>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        {/* Cards */}
                        <div className="bg-card dark:bg-card/80 rounded-xl p-8 shadow-md">
                            <div className="flex items-start gap-4 mb-6">
                                ...
                                <div>
                                    <h3 className="text-foreground text-xl font-bold mb-1 font-display">Expert Local Knowledge</h3>
                        ...
                        <div className="bg-card dark:bg-card/80 rounded-xl p-8 shadow-md">
                            <div className="flex items-start gap-4 mb-6">
                                ...
                                <div>
                                    <h3 className="text-foreground text-xl font-bold mb-1 font-display">Tailor-Made Itineraries</h3>
                                    <p className="text-muted-foreground text-sm leading-relaxed">
                        ...
                        <div className="bg-card dark:bg-card/80 rounded-xl p-8 shadow-md">
                            <div className="flex items-start gap-4 mb-6">
                                ...
                                <div>
                                    <h3 className="text-foreground text-xl font-bold mb-1 font-display">Sustainable &amp; Ethical Travel</h3>
                                    <p className="text-muted-foreground text-sm leading-relaxed">
                        ...
                        <div className="bg-card dark:bg-card/80 rounded-xl p-8 shadow-md">
                            <div className="flex items-start gap-4 mb-6">
                                ...
                                <div>
                                    <h3 className="text-foreground text-xl font-bold mb-1 font-display">24/7 Dedicated Support</h3>
                                    <p className="text-muted-foreground text-sm leading-relaxed">
            ...
            <section className="py-20 px-4 max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
                    <div className="max-w-xl">
                        <h2 className="text-foreground text-3xl md:text-4xl font-black mb-4 font-display">Meet Our Expert Local Guides</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {/* Team Cards */}
                    <div className="bg-card dark:bg-card/80 rounded-xl shadow-md p-6 flex flex-col items-center text-center group transition-transform hover:-translate-y-2">
            ...
            <section className="py-16 bg-primary/5 dark:bg-primary/10 mt-10">
            ...
            <section className="py-24 px-4">
                <div className="relative max-w-5xl mx-auto rounded-xl bg-card overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col items-center justify-center text-center p-12 md:p-20 space-y-8 bg-black/50 rounded-xl">
